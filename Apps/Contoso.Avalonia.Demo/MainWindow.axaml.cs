...
namespace Contoso.Avalonia.Demo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            InitializeComponent();
            UpdateState();
            EventProperties.Items = EventPropertiesSource;
            ErrorProperties.Items = ErrorPropertiesSource;
        ...
        {
            CountryCodeNotice.IsVisible = true;
        ...
        private void TextAttachmentTextBox_OnPropertyChanged(object sender, AvaloniaPropertyChangedEventArgs e)
        {
